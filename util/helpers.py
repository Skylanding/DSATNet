...
from util.metrics import jaccard_loss, dice_loss, active_contour_loss
from util.losses import hybrid_loss, hybrid_loss_ACM
...
def get_criterion(opt):
    ...
    if opt.loss_function == 'bce+dice+acm':
        criterion = hybrid_loss_ACM

    return criterion

# img = torch.randn(2, 3, 256, 256)
# model = torch.load(r'E:\Breast-Ultrasound\JIN_Work_algorithm\checkpoint\model_CUsNet_0.8591.pth')
#
# import argparse
